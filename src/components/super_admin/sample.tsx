      ...
      .then(async (data) => {
        ...
        if (country) {
          try {
            ...
            const symbol = firstCurrency?.symbol ?? '$';

            setClientCurrencySymbol(symbol);
        ...
        <div className="cc-row-grid">
          <Form.Item label="Frequency Cap">
            <div className="cc-unit-input">
              ...
              />
              <span className="acc-unit-label">impressions / user</span>
            </div>
          </Form.Item>
...
function LineItemCard({
  ...
  const currencySymbol = clientCurrencySymbol || '$';   // Better fallback
      ...
      <Form layout="vertical">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <Form.Item label={<span style={{ fontSize: 12.5, color: '#64748b' }}>Ethnicity</span>} style={{ marginBottom: 14 }}>
            <Select
              value={item.ethnicity || undefined}
              ...
              <div key={li.id} style={{ border: '0.5px solid #e2e8f0', borderRadius: 10, marginBottom: 12, overflow: 'hidden' }}>
                ...
                <div className="cc-review-table">
                  {[
                    ...
                    { label: 'Ethnicity', value: li.ethnicity ? li.ethnicity : '—' },
